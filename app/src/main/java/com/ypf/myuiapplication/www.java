...
//    private float fishMainAngle = 0;//鱼的主要朝向角度
//    /**
//     * 鱼的长度值
//     */
//    private int HEAD_RADIUS = 100;//鱼头部的半径
...
//
//        //画鱼头
//        PointF headPoint = calculatePoint(middlePoint, BODY_LENGTH / 2, fishAngle);//鱼头的圆心坐标
...
//        makeTriangel(canvas, middleCenterPoint, FIND_TRIANGLE_LENGTH - HEAD_RADIUS * 0.1f, BIG_CIRCLE_RADIUS - HEAD_RADIUS * 0.2f, fishAngle);
//
//        //身体
...
//        PointF upperCenterPoint = calculatePoint(bottomCenterPoint, findSmallCircleLength, fishAngle - 180);//梯形上底圆的圆心
//        //梯形的四个点
